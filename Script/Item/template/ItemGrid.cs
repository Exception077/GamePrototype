...
public class ItemGrid : MonoBehaviour {
    ...
    public GameObject CountComponent;
    ...
    // 从物品格中删除物品
    public virtual bool onRemoveItem(int count) {
        if (MyItem.Descarded == false) {
            ...
            if (Manager.CurrentItemGridCount < 0) {
                Manager.CurrentItemGridCount = 0;
            }
            Destroy(LoadObj);
        } else {
    ...
    public virtual void initItemGird(Item item, int count) {
    }
}